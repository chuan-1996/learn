 ...
 *
 *         // 通过快速随机访问遍历LinkedList     WARNING:STUPID!
 *         iteratorLinkedListThruForeach(getLinkedList()) ;
 *
 *         // 通过for循环的变种来访问遍历LinkedList   增强型for，除删除外最快
 *         {@linkplain #iteratorThroughFor2(LinkedList)}
 *         iteratorThroughFor2(getLinkedList()) ;
 *
 *         // 通过PollFirst()遍历LinkedList
 *         iteratorThroughPollFirst(getLinkedList()) ; 最快
 *
